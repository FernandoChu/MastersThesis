...
\newcommand{\Type}{\ensuremath{\mathsf{Type}}} % this command is overridden below, so it's commented out
...
\newcommand{\trfib}[3]{\ensuremath{\mathsf{tr}^{#1}(#2,#3)\xspace}}
\newcommand{\Transfib}[3]{\ensuremath{\mathsf{tr}^{#1}\Big(#2,\, #3\Big)\xspace}}
\newcommand{\trfibf}[1]{\ensuremath{\mathsf{tr}^{#1}\xspace}}
...
\newcommand{\cover}{\mathsf{Cover}} % inductive cover
