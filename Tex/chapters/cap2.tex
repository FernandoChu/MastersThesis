...
\begin{example}\label{const-fst}
    ...
    \begin{center}
        ...
        \UnaryInfC{$\Gamma', x{:} A$ ctx} \RightLabel{\footnotesize ctx-Ext}
        \UnaryInfC{$\Gamma', x{:}A, y{:}B$ ctx} \RightLabel{\footnotesize Vble}
        \UnaryInfC{$\Gamma', x{:}A, y{:}B \vdash a:A$}  \RightLabel{\footnotesize $\to$-INTRO}
        \UnaryInfC{$\Gamma', x{:}A \vdash \lam{y:B}a: B \to A$}
        \AxiomC{$\Gamma'$} \RightLabel{\footnotesize Vble}
...
\begin{example}\label{comp-nodep}
    ...
    \begin{center}
        ...
        \UnaryInfC{$\Gamma, (g{:}B\to C) \vdash A : \mathcal{U}_i$}
        \AxiomC{$\Gamma, (g{:}B\to C)$ ctx} \RightLabel{\footnotesize Vble}
        \UnaryInfC{$\Gamma, (g{:}B\to C) \vdash B : \mathcal{U}_i$} \RightLabel{\footnotesize $\to$-FORM}
        \def\defaultHypSeparation{\hskip 3em}
        \BinaryInfC{$\Gamma, (g{:}B\to C) \vdash A\to B{:} \mathcal{U}_i$}\RightLabel{\footnotesize ctx-Ext}
        \UnaryInfC{$\Gamma, (g{:}B\to C), (f{:}A\to B)$ ctx}\RightLabel{\footnotesize Vble}
        \UnaryInfC{$\Gamma, (g{:} B \to C), (f{:} A \to B) \vdash x:A$} \RightLabel{\footnotesize ctx-Ext}
